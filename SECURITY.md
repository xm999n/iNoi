...
- **GitHub Private Security Advisory** (preferred): [Submit here](https://github.com/li-peifeng/iNoi/security/advisories/new)
- **Telegram**: Contact a maintainer privately via [@openinoi](https://t.me/openinoi)
...
- **GitHub 私密安全公告**（推荐）：[点击提交](https://github.com/li-peifeng/iNoi/security/advisories/new)
- **Telegram**：通过 [@openinoi](https://t.me/openinoi) 私信联系维护者
