...
`iNoi` is written in [Go](https://golang.org/) and [SolidJS](https://www.solidjs.com/).
...
Fork and clone `iNoi` and `iNoi-Web` anywhere:

```shell
git clone https://github.com/<your-username>/OpenList.git
git clone --recurse-submodules https://github.com/<your-username>/iNoi-Web.git
```
